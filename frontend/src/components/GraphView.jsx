...
const NODE_STYLES = [
  ...
  { selector: "node[type = 'alias']", style: { "background-color": "#8B5CF6", shape: "hexagon" } },
  ...
  { selector: "node[type = 'discord']", style: { "background-color": "#06B6D4", shape: "round-rectangle" } },
  { selector: "node[type = 'forum_handle']", style: { "background-color": "#8B5CF6", shape: "hexagon" } },
