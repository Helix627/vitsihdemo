  ...
  const handlePrint = () => {
    ...
    printWindow.document.write(`<!DOCTYPE html><html><head>
      ...
      <style>
        ...
        .header-brand { display: flex; align-items: center; gap: 14px; border-bottom: 3px solid #6c47d9; padding-bottom: 12px; margin-bottom: 8px; }
        .header-brand img { width: 44px; height: 44px; }
        h1 { font-size: 24px; margin: 0; color: #1a1a2e; }
        h2 { font-size: 13px; color: #6c47d9; margin: 4px 0 0; letter-spacing: 0.05em; }
        ...
        .badge-red { background: #fee2e2; color: #e11d48; border: 1px solid #fca5a5; }
        .badge-green { background: #dcfce7; color: #059669; border: 1px solid #86efac; }
        ...
        .kpi-val { font-size: 22px; font-weight: 900; color: #6c47d9; }
    ...
    <div className="export-modal-overlay" onClick={onClose}>
      <div className="export-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="export-modal-header">
          <div>
            <h2 className="export-modal-title">Export Intelligence</h2>
        ...
        <div className="export-format-tabs">
          {[
            ...
            { id: "json", label: "CTI JSON" },
            { id: "graph", label: "Graph Snapshot" },
          ...
          {mode === "csv" && (
            <div className="export-mode-panel">
              ...
              <button className="btn-export-action" onClick={handleCSV} type="button">
                Download CSV ({preview?.vendor_count ?? "…"} rows)
              </button>
            </div>
          )}
      ...
      "identifiers": {
        ...
        "pgp": "DEADBEEF..."
              ...
              <button className="btn-export-action" onClick={handleJSON} type="button">
                Download CTI JSON ({preview?.vendor_count ?? "…"} actors)
              </button>
            </div>
          )}
